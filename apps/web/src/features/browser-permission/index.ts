...
const REQUIRED_BROWSER_PERMISSIONS = ["clipboard-read", "clipboard-write"];
...
export const useBrowserPermission = (permission: (typeof REQUIRED_BROWSER_PERMISSIONS)[number]) => {
